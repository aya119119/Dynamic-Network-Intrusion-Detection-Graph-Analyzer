...
import pandas as pd
from src.graph_builder import build_graph, get_graph_statistics, save_graph
...
def main():
    ...
    # Export graph
    save_graph(G, "output/network_graph.gexf")
    print(f"\nGraph exported to output/network_graph.gexf")
